...
constexpr xdna_kernel_variant variants[] = {
    ...
    {
        /* .id                      = */ "aie2p-bf16-gemv-m8192-n1-k2048",
        /* .description             = */ "AIE2P BF16xF32 decode GEMV M=8192 N=1 K=2048",
        /* .environment_variable    = */ "GGML_XDNA_AIE2P_BF16_GEMV_M8192_K2048_BUNDLE",
        /* .xrt_kernel_name         = */ "MLIR_AIE",
        /* .architecture            = */ device_architecture::aie2p,
        /* .op                      = */ operation::mul_mat,
        /* .weights_type            = */ data_type::bf16,
        ...
        /* .artifact_abi_version    = */ 1,
        /* .runtime_opcode          = */ 3,
        /* .weight_bytes            = */ 8192 * 2048 * sizeof(uint16_t),
        /* .device_activation_bytes = */ 2048 * sizeof(uint16_t),
        /* .device_output_bytes     = */ 8192 * sizeof(float),
        /* .rows_per_worker         = */ 8,
        /* .worker_count            = */ 32,
        /* .prefer_for_offload      = */ false,
    },
    {
        /* .id                      = */ "aie2p-bf16-gemv-m8192-n1-k3072",
        /* .description             = */ "AIE2P BF16xF32 decode GEMV M=8192 N=1 K=3072",
        /* .environment_variable    = */ "GGML_XDNA_AIE2P_BF16_GEMV_M8192_K3072_BUNDLE",
        /* .xrt_kernel_name         = */ "MLIR_AIE",
        /* .architecture            = */ device_architecture::aie2p,
        /* .op                      = */ operation::mul_mat,
        /* .weights_type            = */ data_type::bf16,
        ...
        /* .artifact_abi_version    = */ 1,
        /* .runtime_opcode          = */ 3,
        /* .weight_bytes            = */ 8192 * 3072 * sizeof(uint16_t),
        /* .device_activation_bytes = */ 3072 * sizeof(uint16_t),
        /* .device_output_bytes     = */ 8192 * sizeof(float),
        /* .rows_per_worker         = */ 8,
        /* .worker_count            = */ 32,
        /* .prefer_for_offload      = */ false,
