...
Status: pre-upstream candidate (3) for the documented Linux/AIE2P scope; hardening gates passed at 9235eae, with final synchronization/revalidation against newly fetched upstream 3ad1ba7 pending. Not an upstream-quality candidate (4), updated 2026-09-06.
...
This campaign preserves published `25528423a178beb3efb45948546dec49a0c280f6` and rebases onto upstream `73a43d1f69345aee8bb186ef4b3172cef892f2e5`, including its CUDA race correction in the HIP rebuild. Core repair checkpoint: `46d62345900fd8f2372069b144d9dbf8f622ae2f`; hardening checkpoint: `f5ab96a2b13bdbdfcff9736d15549903d252205b`; failure-fixture checkpoint: `6bf091011f63f484198533504ce9418ec2aaffc6`. Callback/packed-Q1 repairs are published through `2e156e44234732c92e454ab532215f75a93edf80`, scale-flags test correction through `7513030cc7780149697a6918ef1652269229ddf9`, and subsequent scheduler/alias repairs through latest confirmed local/origin source `9235eae3e7ea2dfddb54b8b1ee78ad562643f4fd`. The latest upstream fetch remains 73a43d1. Historical sections retain their original evidence boundaries.
...
The f5ab96a, post-callback 7513030 and repaired-source 9235eae real-GGUF matrices each pass all five configurations (CPU, forced selective XDNA, HIP, forced HIP+XDNA, ordinary HIP-first+XDNA) for all five models, with identical stdout hashes between checkpoints:
...
After these completed runs, the final upstream fetch advances to `3ad1ba7336986d98592d3e28cafd1a406715351f`: OpenCL packed-weight eligibility and Spark2.5 model support, with no scheduler/buffer/XDNA/AOT changes. Synchronization and post-rebase validation are tracked separately; the above receipts retain source 9235eae on base 73a43d1.

Fork CI is independently attributed: exact 9235eae CANN run `34042635170` has zero jobs and schema annotation `(Line: 36, Col: 6): Unexpected value ''`, inherited from upstream's empty/commented-out `jobs:`. Four remaining queued runs belong to older commits and have no assigned runners; this C++-only checkpoint does not trigger the path-filtered Python checks. Of fourteen failed repository runs, eleven are CANN schema rejection. Older master WebGPU/Apple runtime failures are real source/test failures, while Docker dependency acquisition and missing runners are infrastructure; none establishes an XDNA regression or CI-green branch. No unrelated CANN/workflow changes were made.

The handoff/raw evidence is in `/home/hamza-usta/.cache/llama-xdna-hardening-20260906-Bc4Pzv`. **Level 3 hardening gates pass at 9235eae; final upstream synchronization/revalidation remains in progress.** Level 4 is not claimed. External gates remain human acceptance of generic hooks/copy policy, cross-host/driver and positive mmap evidence, vendor-defined failed-reset/hidden-abort quiescence, wheel retention and physical CI. No profitability, broader OS/AIE2 support or upstream submission is implied.
